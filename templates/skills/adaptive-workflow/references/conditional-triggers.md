...
| New or restructured skill | Follow the [`skill-authoring`](../../skill-authoring/SKILL.md) skill, and mirror `.claude/skills/` into `templates/skills/` in the same commit. `tests/test_skills.py` checks both. |
